...
class LineWrapper extends EventEmitter {
  constructor(document, options) {
    ...
    //console.log("LineWrapper.constructor, options="+JSON.stringify(options));
    if (options.height != null && options.height != Infinity) {
      this.height = options.height;
      this.maxY = this.startY + options.height;
    } else {
      this.maxY = this.document.page.maxY();
    }
    //console.log("LineWrapper.constructor, maxY="+this.maxY);
  ...
  nextSection(options) {
    console.log("LineWrapper.nextSection, options="+JSON.stringify(options));
    this.emit('sectionEnd', options, this);
