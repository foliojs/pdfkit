...
export default {
  ...
  // this is called from _setColorCore
  ...
  // this comes from the .fill or .stroke methods
  ...
  _getColorSpace(color) {
    ...
    if (color.length === 4) return 'DeviceCMYK';
    if (color.length === 3) return 'DeviceRGB';
    return 'DeviceRGB';
  },
