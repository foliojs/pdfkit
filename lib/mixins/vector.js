...
export default {
  ...
  /**
   * @param {string} cornerConfig - Specify which corners should have a radius applied.
   * Default '1111'. '0000' would mean no corners would have a radius. Order of bits are:
   * top right, bottom right, bottom left and top left.
   */
  roundedRect(x, y, w, h, r, cornerConfig) {
    if (r == null) {
      r = 0;
    }
