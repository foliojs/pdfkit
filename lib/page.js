...
class PDFPage {
  constructor(document, options = {}) {
    ...
    this.size = options.size || (document.page && document.page?.size) || 'letter';
    this.layout = options.layout || (document.page && document.page != null && document.page?.layout) || 'portrait';
